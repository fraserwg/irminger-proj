...
#SBATCH --array=0-45,47-49
#SBATCH --job-name=AIrm
#SBATCH --time=24:00:00
#SBATCH --nodes=16
#SBATCH --tasks-per-node=75
#SBATCH --cpus-per-task=1
#SBATCH --qos=taskfarm
#SBATCH --account=n01-OXF1
...
export RUN_DIR=run"$SLURM_ARRAY_TASK_ID"_a
export NEXT_RUN_DIR=run"$SLURM_ARRAY_TASK_ID"_b
